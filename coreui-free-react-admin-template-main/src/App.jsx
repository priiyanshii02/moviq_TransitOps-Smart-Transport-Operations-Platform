...
// Pages
const AnimatedLogin = React.lazy(() => import('./views/pages/login/AnimatedLogin'))
    ...
    <HashRouter>
      ...
      >
        <Routes>
          ...
          <Route exact path="/login" name="Animated Login" element={<AnimatedLogin />} />
          <Route exact path="/login-old" name="Login Page" element={<Login />} />
